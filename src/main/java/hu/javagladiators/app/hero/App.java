...
import hu.javagladiators.app.hero.model.Faj;
...
public class App {
    ...
    private static final Faj[] fajok = new Faj[3];
    ...
    static {
        ...
        fajok[0]=new Faj("Orc", "...");
        fajok[1]=new Faj("Hulk", "...");
        fajok[2]=new Faj("Alien", "...");
        
        heroes[0].addHybrid(fajok[0], 50);
        heroes[0].addHybrid(fajok[2], 50);
    ...
    public static void main(String[] args) {
        ...
        for(AvailableHero hero:getAvailableHeroes(empire.getProvinces().get(0).getLocations().get(0))){
            ...
            for (Faj faj : hero.getHero().getHybrid().keySet()) {
                System.out.println(faj.getName() + " " + hero.getHero().getHybrid().get(faj));
            }
